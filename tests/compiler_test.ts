...
Deno.test(
  "Tokenize nested CallExpressions",
  () => {
...
Deno.test(
  "Tokenize not nested CallExpressions",
  () => {
    const input = `(add 1)
  (subtract 6 5)
  `;
...
Deno.test(
  "parse not nested CallExpression",
  () => {
    const input = `(add 1)
  (subtract 6 5)
  `;
...
Deno.test(
  "Transform ast for nested CallExpressions",
  () => {
    const input = "(add 1 (subtract 6 5))";
    const tokens = tokenize(input);
    const ast = parse(tokens);
...
Deno.test(
  "Transform ast for not nested CallExpressions",
  () => {
    const input = `(add 1)
  (subtract 6 5)
  `;
...
Deno.test(
  "Transform ast for StringLiterals",
  () => {
...
Deno.test(
  "Transform ast for nested StringLiterals",
  () => {
...
Deno.test(
  "generate code for nested CallExpressions",
  () => {
    const input = "(add 1 (subtract 6 5))";
    const tokens = tokenize(input);
    const ast = parse(tokens);
...
Deno.test(
  "generate code for not nested CallExpressions",
  () => {
    const input = `(add 1)
  (subtract 6 5)`;
    const tokens = tokenize(input);
...
Deno.test(
  "compiler for code with nested CallExpressions",
  () => {
    const input = "(add 1 (subtract 6 5))";
...
Deno.test(
  "compiler for code with not nested CallExpressions",
  () => {
    const input = `(add 1)
  (subtract 6 5)`;
    const output = compile(input);
